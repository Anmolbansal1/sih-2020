...
def test():
    modeldir = os.path.join(os.getcwd(),'model','20170511-185253.pb')
    classifier_filename = os.path.join(os.getcwd(),'class','classifier.pkl')
    npy=os.path.join(os.getcwd(),'npy')
    train_img=os.path.join(os.getcwd(),'training_files','img')
    classes=os.listdir(train_img)
    classes.sort()
    prev=time.time()
